                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <form action="/inputmapel" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}

                                <div class="form-group">
                                    <label class="col-form-label">Cover Mata Pelajaran</label>
                                    <br>
                                    <input type="file" id="cover" name="cover" accept="image/*">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">Nama Mata Pelajaran Baru</label>
                                    <input type="text" class="form-control" placeholder="Mata Pelajaran Baru" id="mapel"
                                        name="mapel" />
                                </div>
                                <br>
                            ...
                            <div class="alert alert-danger">
                                <div>
                                    <h2 style="text-align:center;">{{Session::get('alert')}}</h2>
                                </div>
                            </div>
                            @endif
                            @if(\Session::has('alert-nama'))
                            <div class="alert alert-danger">
                                <div>
                                    <h2 style="text-align:center;">{{Session::get('alert-nama')}}</h2>
                                </div>
                            </div>
                            @endif

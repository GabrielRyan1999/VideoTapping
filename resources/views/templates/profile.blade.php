          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{Asset ('uploads/avatars/'. Session::get('avatar') ) }}" alt="..." class="img-circle profile_img">
              </div>
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3  profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" src="{{Asset ('uploads/avatars/'. Session::get('avatar') ) }}" alt="Avatar" title="{{Session::get('name')}}"
...
<input type="hidden">{{ Session::get('id')}}</input> -->
            ...
            <form>
              ...
              <div>
                <input type="text" id="nomorinduk" size="30" class="form-control"  value="{{Session::get('nomorinduk')}}" READONLY/><br>
              </div>          
              <label for="name">Nama</label><br>
              <div>
                <input type="text" id="name" size="30" class="form-control" value="{{Session::get('name')}}" READONLY/><br>
              </div>
              <br>
